...
echo "${BG_BLUE}${WHITE}${BOLD}Welcome to tech with Ro!${RESET}"
echo "${CYAN}${BOLD}Check out more cloud lab at:${RESET}"
echo "${YELLOW}${BOLD}http://www.youtube.com/@ro_patil${RESET}"
